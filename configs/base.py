...
# --- 清晰度处理后的数据集JSON文件命名 ---
SHARPNESS_AVERAGED_JSON_FILENAME = "master_sharpness_averaged_dataset.json"
SHARPNESS_AVERAGED_SSL_JSON_FILENAME = "master_sharpness_averaged_ssl_dataset.json"

# 各数据集的清晰度平均化JSON文件
DATASET_SHARPNESS_AVERAGED_JSONS = {
    "dataset1_LInCl": "dataset1_LInCl_sharpness_averaged.json",
    "dataset2_LPSCl": "dataset2_LPSCl_sharpness_averaged.json", 
    "dataset3_LNOCl": "dataset3_LNOCl_sharpness_averaged.json"
}

# --- 5. 工具与日志配置 (Tools and Logging Configuration) ---
WANDB_ENABLED = True  # 设置为 True 启用, 设置为 False 禁用

# --- 6. 统一日志目录配置 (Unified Logging Directory Configuration) ---
# 基础日志目录，所有日志文件都将保存在此目录下
BASE_LOG_DIR = PROJECT_ROOT / "runs"