...
# --- 数据集 ---
JSON_DIR_NAME = "json"
UNLABELED_JSON_NAME = "master_ssl_dataset.json"  # 使用SSL专用的清晰度平均化数据集
...
# **关键修正**: 动态构建检查点目录
CHECKPOINT_DIR_NAME = f"ssl_pretrained_{ENCODER_NAME}_2"
...
# --- 日志记录配置 ---
LOGGER = 'tensorboard'
log_dir = cfg_base.BASE_LOG_DIR / LOGGER / MODEL_NAME
log_config = {
    'logger': LOGGER,
    'project': 'SRPU-Model',
    'log_dir': str(log_dir)
